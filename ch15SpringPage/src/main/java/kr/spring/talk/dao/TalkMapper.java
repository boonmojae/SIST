...
public interface TalkMapper {
		...
		public void insertTalkRoomMember(@Param(value="talkroom_num") Long talkroom_num,@Param(value="room_name") String room_name,@Param(value="mem_num") Long mem_num);//마이바티스 인자 여러개 쓰고싶으면 3점대annotation사용가능/map으로 묶어서 전달(기존방식)
		//채팅방 멤버 읽기
		...
		//읽지 않은 채팅 기록 저장(map이 아닌 개별적으로 보낼땐 @Param 사용,해당인자에 식별자 정함)
