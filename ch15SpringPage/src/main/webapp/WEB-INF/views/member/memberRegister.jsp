...
<!-- 회원가입 시작 -->
<div class="page-main">
	<h2>회원가입</h2>										  <!-- 자바빈 초기화 한거 넣어줌 -->
	<form:form action="registerUser" id="member_register" modelAttribute="memberVO">
	<ul>
		<li>
			<form:label path="id">아이디</form:label><!-- path="id"-> for="id로 바뀜 -->
			<form:input path="id" placeholder="영문,숫자만 4~12자" autocomplete="off"/><!-- 힌트 기능/autocomplete자동완성 안되게 -->
		...
		<li>
			...
			<form:input path="nick_name"/><!-- 별명은 필수X -->
		</li>
		<li>
	...
	<div class="align-center">
		...
		<input type="button" value="홈으로" class="default-btn" onclick="location.href='${pageContext.request.contextPath}/main/main'"><!-- /main/main확장자가 없어서 이렇게 명시 -->
	</div>
	</form:form>
