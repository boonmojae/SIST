...
window.onload=function(){
	...
	myForm.onsubmit=function(){
		const items = document.querySelectorAll('input[type="text"],input[type="password"],textarea');//속성선택자로하거나 class만들어서
	...
	<form id="update_form" action="update.jsp" method="post">
		...
		<ul>
			...
			<li>
				...
				<textarea rows="5" cols="40" name="content" id="content"><%= board.getContent() %></textarea><!-- textarea는 미리보기 위치 다름 -->
			</li>
		</ul>
