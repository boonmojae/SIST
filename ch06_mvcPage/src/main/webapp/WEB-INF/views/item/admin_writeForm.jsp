...
<script type="text/javascript">
	window.onload=function(){
		...
		myForm.onsubmit=function(){
			const radio = document.querySelectAll('input[type=radio]');
			if(radio.length < 1){
				alert('상품표시여부를 지정하세요');
				return false;
			}
...
<div class="page-main">
	...
	<div class="content-main">
		<h2>상품등록</h2>
		<form id="write_form" action="adminWrite.do" method="post" enctype="multipart/form-data"><%--파일 업로드 할떈 enc 명시해야됨 --%>
			<ul>
				<li>
					<label>상품표시여부</label>
