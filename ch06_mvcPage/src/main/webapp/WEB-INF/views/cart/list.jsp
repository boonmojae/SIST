...
<div class="page-main">
	...
	<div class="content-main">
		...
		<c:if test="${!empty list}">
		<form id="cart_order" action="${pageContext.request.contextPath}/order/orderForm.do" method="post"><%-- ajax통신 --%>
			<table>
				<tr>
					<th>상품명</th>
					<th>수량</th>
				...
				<tr>
					<td>
						<a href="${pageContext.request.contextPath}/item/detail.do?item_num=${cart.item_num}"><%-- get방식으로 프라이머리키 읽어옴 --%>
