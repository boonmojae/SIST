...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/board.fav.js"></script><%-- 좋아요 스크립트 따로 만듦 --%>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/board.reply.js"></script><%-- 게시글 댓글 --%>
</head>
<body>
<div class="page-main">
   ...
   <div class="content-main">
      ...
      <ul class="detail-sub">
         <li>
            <%-- 좋아요 --%>
            <img id="output_fav" data-num="${board.board_num}" src="${pageContext.request.contextPath}/images/fav01.gif" width="50"><%--속성을 만들고싶으면 data-로 시작하면됨/board_num을 가져오기위해 가장 가까운곳에서 만듦 --%>
            좋아요
