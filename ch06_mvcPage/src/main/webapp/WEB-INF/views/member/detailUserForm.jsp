...
<div class="page-main">
	...
	<div class="content-main">
		...
		<form action="adminUser.do" method="post" id="detail_form"><%-- 데이터가 변경되는거라 post방법으로 전송 --%>
			<input type="hidden" name="mem_num" value="${member.mem_num}"><%--session에 있는건 관리자 사용번호로 사용X/hidden에 있는거 써야됨 --%>
			<ul>
				<li>
					<label>등급</label><%--radio사용할거라 for명시 안함 --%>
			...
			<div class="align-center">
				<c:if test="${member.auth!=9}"><%--일반인 경우에만 변경 가능,관리자X --%>
