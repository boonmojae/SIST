	...
	<div class="content-main">
		...
		<form id="register_form" action="registerUser.do" method="post">
			...
			<div class="align-center">
				...
				<input type="button" value="홈으로" onclick="location.href='${pageContext.request.contextPath}/main/main.do'"><!-- 경로가 다를경우 uri방식으로 작성,자바스크립트에 문자열 제공하는거라''있어야됨 -->
			</div>
		</form>
		<!-- 다음 우편번호 API 시작 -->
